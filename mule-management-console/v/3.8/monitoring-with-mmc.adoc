...
本节假定您已清楚了解 link:/mule-management-console/v/3.8/architecture-of-the-mule-management-console[Mule管理控制台的架构]，并且您的计算机中已有 link:/mule-management-console/v/3.8/installing-mmc[安装了管理控制台]。
...
|
*  link:/mule-management-console/v/3.8/analyzing-business-events[商业活动]
| image:icon-clipboard-blue-big.png[图标剪贴板 - 蓝 - 大]
|
*  link:/mule-management-console/v/3.8/analyzing-flow-processing-and-payloads[流内容]
| image:icon-mulesoftm-blue-big.png[图标mulesoftm  - 蓝 - 大]
|
*  link:/mule-management-console/v/3.8/managing-mule-servers-clusters-and-groups[JVM]（Mule的实例）
...
*  link:/mule-management-console/v/3.8/customizing-the-dashboard[自定义管理控制台仪表板]
| image:icon-dashboard-blue-big.png[图标式仪表板蓝大]
|
*  link:/mule-management-console/v/3.8/customizing-the-dashboard[监视仪表板上的所有内容]
|===
