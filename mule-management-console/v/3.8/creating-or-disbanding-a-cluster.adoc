...
[TIP]
您还可以使用管理控制台 link:/mule-management-console/v/3.8/rest-api-reference[REST API]以编程方式创建和解散集群。
...
票据文件将信息存储为键=值对。有关此文件中允许的参数列表，请参阅 link:/mule-user-guide/v/3.8/creating-and-managing-a-cluster-manually[手动创建和管理群集]。
...
* 手动阅读关于 link:/mule-user-guide/v/3.8/creating-and-managing-a-cluster-manually[配置群集节点]的更多信息。
* 了解 link:/mule-management-console/v/3.8/deploying-redeploying-or-undeploying-an-application-to-or-from-a-cluster[部署]和 link:/mule-management-console/v/3.8/monitoring-a-cluster[监控]个群集。
