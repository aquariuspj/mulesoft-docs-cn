...
* 具有有效 link:/mule-user-guide/v/3.8/installing-an-enterprise-license[企业许可证]的{​​{0}}实例
* 部署在 link:/mule-user-guide/v/3.8/hardware-and-software-requirements[支持Web应用程序服务器]中的MMC控制台应用程序文件（mmc.war）
...
*  link:/mule-management-console/v/3.8/installing-mmc[安装MMC]
*  link:/mule-management-console/v/3.8/orientation-to-the-console[东方]自己到控制台
* 熟悉使用 link:/mule-management-console/v/3.8/mmc-walkthrough[MMC演练]的基本操作

== 另请参阅

*  link:/mule-management-console/v/3.8/setting-up-mmc[设置您的MMC实例]与您企业中的其他组件一起使用
