...
您可以从主要“商业活动”屏幕设置交易查询，该屏幕将在您单击“商业活动”选项卡时打开。如果您想跟踪默认事件，请确保首先为您的应用程序启用默认事件生成和跟踪，如 link:/mule-user-guide/v/3.8/business-events[商业活动]中所述。
...
[NOTE]
====
请注意，您可以在您的Mule应用程序中自定义事务ID以使其更有意义。有关更多详情，请参阅 link:/mule-user-guide/v/3.8/business-events[商业活动]。
====
