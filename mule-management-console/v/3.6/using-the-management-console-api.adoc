...
有关可通过REST执行的所有操作（包括使用和输出示例）的完整详细信息，请参阅 link:/mule-management-console/v/3.6/rest-api-reference[REST API参考]。
...
有关这些操作的详细信息，请参阅 link:/mule-management-console/v/3.6/rest-api-reference[REST API参考]。
...
[TIP]
====
link:/mule-management-console/v/3.6/rest-api-reference[REST API参考]包含管理控制台REST API上所有可用操作的完整详细信息，包括输入数据和结果的示例。
====
