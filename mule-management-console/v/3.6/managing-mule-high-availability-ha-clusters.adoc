...
*  link:/mule-management-console/v/3.6/creating-or-disbanding-a-cluster[创建一个集群]
...
*  link:/mule-management-console/v/3.6/creating-or-disbanding-a-cluster[“解散”或删除群集]
