...
本节假设您已清楚了解您的计算机中 link:/mule-management-console/v/3.6/architecture-of-the-mule-management-console[MMC的用途是什么]和您已有 link:/mule-management-console/v/3.6/installing-mmc[安装管理控制台]的内容。
