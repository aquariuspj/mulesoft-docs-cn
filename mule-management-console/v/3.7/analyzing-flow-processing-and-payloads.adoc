...
*  link:/mule-management-console/v/3.7/debugging-message-processing[调试消息处理]说明调试应用程序的消息处理的一般步骤。
*  link:/mule-management-console/v/3.7/debugging-the-loan-broker-example-application[调试贷款代理示例应用程序]显示如何使用控制台流量分析器屏幕查找应用程序逻辑错误。
*  link:/mule-user-guide/v/3.7/routers[使用消息处理器来控制消息流]为可用的Mule消息处理器或路由器提供参考信息。
