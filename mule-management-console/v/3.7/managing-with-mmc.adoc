...
本节假设您已清楚了解 link:/mule-management-console/v/3.7/architecture-of-the-mule-management-console[MMC的基本架构]，并且您已有 link:/mule-management-console/v/3.7/installing-mmc[安装管理控制台]。
...
link:/mule-management-console/v/3.7/monitoring-a-server[服务器]

image:icon-gears-blue-big.png[图标，齿轮，蓝色大] +

link:/mule-management-console/v/3.7/maintaining-the-server-application-repository[应用]
