...
本文档以及组成 link:/mule-management-console/v/3.4/rest-api-reference[Mule管理控制台REST API参考指南“]的其他文档仅为技术参考。本文档不提供诸如说明，用例或方案的上下文信息。要理解本文档，您应该熟悉 link:/mule-user-guide/v/3.4[MULE ESB]，群集和 link:/mule-management-console/v/3.4/using-the-management-console-api[REST API]。
