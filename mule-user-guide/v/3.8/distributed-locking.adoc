...
* 访问 link:/mule-user-guide/v/3.8/mule-high-availability-ha-clusters[Mule高可用性（HA）群集]进行概述。

* 了解如何 link:/mule-user-guide/v/3.8/creating-and-managing-a-cluster-manually[手动创建和管理群集，]访问其他选项。

* 了解如何启用 link:/mule-user-guide/v/3.8/distributed-file-polling[分布式文件轮询]。
