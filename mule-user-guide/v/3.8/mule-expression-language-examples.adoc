...
本文假设您熟悉Mule Expression Language的 link:/mule-user-guide/v/3.8/mule-expression-language-basic-syntax[基本语法]，并且使用 link:/anypoint-studio/v/6/[骡子工作室]或XML轻松构建和运行Mule应用程序。
...
* 访问Mule表达式语言 link:/mule-user-guide/v/3.8/mule-expression-language-reference[参考]和 link:/mule-user-guide/v/3.8/mule-expression-language-tips[提示]。
