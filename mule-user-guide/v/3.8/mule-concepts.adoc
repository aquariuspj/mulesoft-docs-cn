...
在流的消息处理器的许多字段中，可以使用 link:/mule-user-guide/v/3.8/mule-expression-language-mel[骡子表达语言]提取有关消息或其环境的信息，并指示Mule根据该信息作出处理决策。
...
*  link:/anypoint-exchange[例子]



== 另请参阅

*  *NEXT STEP:*详细了解 link:/mule-user-guide/v/3.8/elements-in-a-mule-flow[骡子流中的元素]。
* 详细了解 link:/mule-user-guide/v/3.8/batch-processing[批量处理]。 +
