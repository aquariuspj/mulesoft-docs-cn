...
此页面提供有关在Mule配置的根级配置的全局设置的详细信息。有关配置的更多信息，请参阅 link:/mule-user-guide/v/3.8/about-mule-configuration[关于Mule配置]。有关线程配置文件的信息，请参阅 link:/mule-user-guide/v/3.8/tuning-performance[调整性能]。
