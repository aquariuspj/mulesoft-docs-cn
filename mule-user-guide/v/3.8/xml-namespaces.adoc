...
您可以在Mule中的任何基于XML的功能上指定命名空间，包括JXPath过滤器，Jaxen过滤器，XPath过滤器，基于过滤器的分离器，表达式分离器，循环分解器，JXPath提取器转换器和XPath表达式转换器0}}和 link:/mule-user-guide/v/3.8/xpath-annotation[XPath注释]。
