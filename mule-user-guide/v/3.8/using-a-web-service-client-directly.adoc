...
本页介绍如何在Mule中使用独立的CXF生成的客户端。这种方法与 link:/mule-user-guide/v/3.8/consuming-web-services-with-cxf[出站路由器]方法不同，后者通常更适合于大多数应用程序。
...
以下是如何使用 link:/mule-user-guide/v/3.8/building-web-services-with-cxf[使用CXF构建Web服务]中开发的服务构建客户端的示例：
