...
除了此页面上介绍的功能外，您还可以使用启用高效XPath XML路由的 link:/mule-user-guide/v/3.8/sxc-module-reference[SXC模块参考]。
...
-  `xpath2()`函数，由 link:/mule-user-guide/v/3.8/xpath[xpath3（）]函数取代
-  `JXPath`提取器+
-  `JXPath`过滤器+
-  `Jaxen`过滤器+

新功能： link:/mule-user-guide/v/3.8/xpath[xpath3（）]，其中包括改进的返回类型处理。有关详情，请参阅 link:/mule-user-guide/v/3.8/xpath[XPath的]。 +
*Version 1*  - 不支持+
*Version 2*  - 支持+
*Version 3*  - 支持
|的XQuery
| link:/mule-user-guide/v/3.8/xslt-transformer[XSLT变压器]现在支持XSLT 3.0。变压器的行为和语法保持不变，您可以手动选择变压器应使用的XSLT版本。有关详细信息，请参阅 link:/mule-user-guide/v/3.8/xslt-transformer[XSLT变压器]文档。 +
*Version 1*  - 支持+
*Version 2*  - 支持+
*Version 3*  - 支持
| XSLT
| link:/mule-user-guide/v/3.8/xquery-transformer[XQuery变换器]现在支持XQuery 3.0。转换器的行为和语法保持不变，您可以手动选择变压器应使用的XQuery版本。有关详情，请参阅 link:/mule-user-guide/v/3.8/xquery-transformer[XQuery变换器]和 link:/mule-user-guide/v/3.8/xquery-support[XQuery支持]。 +
*Version 1*  - 支持+
*Version 2*  - 支持+
*Version 3*  - 支持
|===
...
| link:/mule-user-guide/v/3.8/jxpath-extractor-transformer[JXPath提取器] _ *Deprecated* _  |使用JXPath使用XPath表达式查询和提取对象图。弃用`xpath3()`函数（请参阅 link:/mule-user-guide/v/3.8/xpath[XPath的]）。
...
XML模块包含各种XPath过滤器。有关如何使用过滤器的一般详情，请参阅 link:/mule-user-guide/v/3.8/filters[过滤器]。

===  XPath筛选器

[NOTE]
Mule 3.6.0和更高版本支持XPath 3.0，它与XPath 2.0向后兼容。另一方面，XPath 1.0已弃用，尽管简单的表达式可能有效，但某些表达式可能不兼容。有关详情，请参阅 link:/mule-user-guide/v/3.8/xpath[XPath的]。
...
有关`xpath3`函数的详细说明，请参阅 link:/mule-user-guide/v/3.8/xpath[XPath的]。
====
