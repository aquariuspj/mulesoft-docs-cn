...
对于这些语言中的每一种，除"component"之外，还有一个 link:/mule-user-guide/v/3.8/script-transformer-reference[变压器]。变形金刚更专业化，他们已经准备好将消息的有效载荷作为输入，并将有效载荷作为输出返回。任何你可以用变压器做的事情也可以用一个组件完成。
...
[TIP]
Keep in mind that if you'd rather code in Java, there's also a link:/mule-user-guide/v/3.8/java-component-reference[Java Component] that works very similarly.
...
* 欲了解更多信息，请参阅Mule页面 link:/mule-user-guide/v/3.8/scripting-module-reference[脚本模块]
* 详细了解 link:/mule-user-guide/v/3.8/javascript-component-reference[JavaScript组件]
* 详细了解 link:/mule-user-guide/v/3.8/ruby-component-reference[Ruby组件]
* 详细了解 link:/mule-user-guide/v/3.8/groovy-component-reference[Groovy组件]
* 详细了解 link:/mule-user-guide/v/3.8/python-component-reference[Python组件]
* 详细了解 link:/mule-user-guide/v/3.8/java-component-reference[Java组件]
