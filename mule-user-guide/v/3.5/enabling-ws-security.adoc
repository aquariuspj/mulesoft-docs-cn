...
对于涉及Web服务的Mule流，添加 link:/mule-user-guide/v/3.5/cxf-component-reference[CXF组件]以发布，使用或代理Web服务。完成以下步骤以在SOAP组件上配置WS-security。
...
link:http://www.mulesoft.org/schema/mule/cxf/3.5/mule-cxf.xsd[查看Mule 3.5 CXF模式]。
