...
[NOTE]
本主题介绍全球元素的概念;如果您不熟悉此功能，请在继续之前访问 link:/mule-user-guide/v/3.9/global-elements[了解全球骡子元素]以了解更多信息。
...
* 访问演示Anypoint Enterprise Security的 link:/mule-user-guide/v/3.9/anypoint-enterprise-security-example-application[示例应用]。
