...
IMAP连接器支持所有 link:/mule-user-guide/v/3.9/configuring-a-transport[常见的连接器属性和属性]和以下附加属性：
...
IMAP和IMAPS端点包含有关连接到IMAP邮箱的详细信息。您 link:/mule-user-guide/v/3.9/endpoint-configuration-reference[配置端点]与其他运输方式一样，具有以下附加属性：
