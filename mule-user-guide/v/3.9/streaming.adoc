...
*  link:/mule-user-guide/v/3.9/database-connector-reference[数据库连接器]
*  link:/mule-user-guide/v/3.9/file-transport-reference[文件]（将`streaming`属性设置为false以直接访问File对象）
*  link:/mule-user-guide/v/3.9/ftp-transport-reference[FTP]
*  link:/mule-user-guide/v/3.9/http-listener-connector[HTTP侦听器]和HTTPS侦听器。
*  link:/mule-user-guide/v/3.9/jetty-transport-reference[码头]和 link:/mule-user-guide/v/3.9/jetty-ssl-transport[Jetty SSL]
*  link:/mule-user-guide/v/3.9/servlet-transport-reference[Servlet的]
...
*  link:/mule-user-guide/v/3.9/domtoxml-transformer[DomToOutputHandler转换器]（如果传入的XML格式是SAXSource或XMLStreamReader）
*  link:/mule-user-guide/v/3.9/sxc-module-reference[SXC过滤器]
