...
* 访问 link:/mule-user-guide/v/3.9/mule-high-availability-ha-clusters[Mule高可用性（HA）群集]进行概述。

* 了解如何 link:/mule-user-guide/v/3.9/creating-and-managing-a-cluster-manually[手动创建和管理群集，]访问其他选项。

* 了解如何启用 link:/mule-user-guide/v/3.9/distributed-file-polling[分布式文件轮询]。
