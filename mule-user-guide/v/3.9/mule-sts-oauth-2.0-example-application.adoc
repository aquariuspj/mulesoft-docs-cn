...
+
[IMPORTANT]
`tweetbook-oauth2-provider`样本实现了 link:/mule-user-guide/v/3.9/anypoint-enterprise-security[Anypoint企业安全]集合中可用的`OAuth provider module`。
+
. 如果您尚未安装，请按照 link:/mule-user-guide/v/3.9/installing-anypoint-enterprise-security[安装Anypoint Enterprise Security]中的详细步骤操作。
...
有关其他类型授权许可的更多信息，请参阅 link:/mule-user-guide/v/3.9/authorization-grant-types[授权授予类型]。
...
* 有关Mule中Oauth 2.0的更多信息，请参阅 link:/mule-user-guide/v/3.9/mule-secure-token-service[Mule安全令牌服务]。
