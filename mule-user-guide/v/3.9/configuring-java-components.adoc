...
有关使用`<spring-object/>`的真实示例，请参阅 link:/mule-user-guide/v/3.9/using-spring-beans-as-flow-components[使用Spring Beans作为流程组件]。
...
您可以配置入口点解析器，以确定在流接收到消息时如何调用组件。有关其功能的更详细说明，请参阅 link:/mule-user-guide/v/3.9/developing-components[开发组件]。
...
有关生命周期的更多信息，请参阅 link:/mule-user-guide/v/3.9/developing-components[开发组件]。
...
绑定可用于Java组件和脚本组件。有关更多信息，请参阅 link:/mule-user-guide/v/3.9/component-bindings[组件绑定]。
...
有关合并配置选项的池和参考文档的更多信息，请参阅 link:/mule-user-guide/v/3.9/tuning-performance[调整性能]。
