...
Mule提供 link:/mule-user-guide/v/3.9/jmx-management[JMX支持的几个代理]，包括通知和远程管理。您还可以创建自定义代理以将任何功能插入到Mule中，例如将功能作为后台进程运行或将服务器嵌入到Mule中。
...
有关Mule提供的代理列表以及如何配置它们的信息，请参阅 link:/mule-user-guide/v/3.9/jmx-management[JMX管理]。您还可以按照以下说明创建自定义代理。
