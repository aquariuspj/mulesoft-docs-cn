...
SAP Connector提供了多种功能，超出了 link:/mule-user-guide/v/3.9/sap-connector[SAP连接器文档]中已经描述的基本功能。本文档将帮助您充分利用SAP Mule应用程序的全部潜力。
...
重要提示：这些属性的键名必须符合JCo库所需的*match*。您可以在 link:/mule-user-guide/v/3.9/sap-connector-advanced-features#jco-client-properties[SAP客户端属性]和 link:/mule-user-guide/v/3.9/sap-connector-advanced-features#jco-server-properties[SAP服务器属性]查看。
...
[NOTE]
您可以在地址属性中使用 link:/mule-user-guide/v/3.9/mule-expression-language-mel[骡子表达]，就像您为其他Mule传输一样。
...
[WARNING]
集群中充分运行的应用程序的关键是实现 link:/mule-user-guide/v/3.9/reliability-patterns[可靠性模式]。
...
[NOTE]
有关更多信息，请参阅 link:/mule-user-guide/v/3.9/transactions-configuration-reference[事务配置参考]。
...
*  link:/mule-user-guide/v/3.9/sap-connector-troubleshooting[SAP Connector故障排除]来处理常见问题。
