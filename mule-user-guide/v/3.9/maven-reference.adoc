...
本页总结了有助于使用Maven和Mule的参考信息。有关介绍和概述，请参阅 link:/mule-user-guide/v/3.9/using-maven-with-mule[和Mule一起使用Maven]。
...
请参阅 link:/mule-user-guide/v/3.9/configuring-maven-to-work-with-mule-esb[配置Maven以使用Mule]。
