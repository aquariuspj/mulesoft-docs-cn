...
[NOTE]
====
您可以使用实现类而不是服务接口，但服务接口可以更容易地使用该服务。有关更多信息，请参阅 link:/mule-user-guide/v/3.9/consuming-web-services-with-cxf[消费Web服务]。
====
...
有关支持的消息样式的更多信息，请参阅： link:/mule-user-guide/v/3.9/creating-flow-objects-and-transformers-using-annotations[使用注释创建流对象和变形金刚]。
