...
有关热部署Mule应用程序的更多信息，请参阅 link:/mule-user-guide/v/3.9/application-server-based-hot-deployment[基于应用服务器的热部署]。
...
. 将您的Mule应用程序的配置文件和自定义Java类打包到`.war`文件中（请参阅 link:/mule-user-guide/v/3.9/application-server-based-hot-deployment[基于应用服务器的热部署]）。
