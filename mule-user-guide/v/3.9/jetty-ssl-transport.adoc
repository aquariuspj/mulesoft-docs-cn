...
Jetty SSL传输的工作方式与 link:/mule-user-guide/v/3.9/https-transport-reference[HTTPS传输参考]完全相同。
...
如果您不需要此级别的安全性，则可以使用 link:/mule-user-guide/v/3.9/jetty-transport-reference[码头运输参考]。
