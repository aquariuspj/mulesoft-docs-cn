...
*  link:/mule-user-guide/v/3.9/cxf-module-overview[概观]
*  link:/mule-user-guide/v/3.9/building-web-services-with-cxf[构建Web服务]
*  link:/mule-user-guide/v/3.9/consuming-web-services-with-cxf[消费Web服务]
*  link:/mule-user-guide/v/3.9/proxying-web-services-with-cxf[代理Web服务]
*  link:/mule-user-guide/v/3.9/using-http-get-requests[使用HTTP GET请求]
*  link:/mule-user-guide/v/3.9/cxf-module-configuration-reference[配置参考]
*  link:/mule-user-guide/v/3.9/wsdl-connectors[使用WSDL连接器]
