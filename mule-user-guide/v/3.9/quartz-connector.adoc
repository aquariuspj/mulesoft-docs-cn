...
请注意，您也可以选择在流程开始时使用Poll范围，该范围也支持Cron表达式和水印。详细了解 link:/mule-user-guide/v/3.9/poll-reference[调查范围]。
...
* 有关使用XML编辑器设置Quartz端点属性的详细信息，请参阅 link:/mule-user-guide/v/3.9/quartz-transport-reference[石英运输参考]。
...
* 阅读有关 link:/mule-user-guide/v/3.9/poll-reference[调查范围]的信息。
