...
有关如何编辑这些设置的说明，请参阅 link:/mule-user-guide/v/3.9/logging-in-mule[登录Mule]。
...
* 详细了解 link:/mule-user-guide/v/3.9/logging-in-mule[登录Mule]。
* 查看 link:/mule-user-guide/v/3.9/mule-expression-language-mel[骡子表达语言]参考，了解如何格式化有用的记录器消息的更多提示。
