...
本文档假定您熟悉Mule及其 link:/mule-user-guide/v/3.9/mule-concepts[基本概念]。
...
.  *Understand the Mule message structure.*因为您使用MEL来处理Mule消息对象（负载，属性和变量）的内容，您首先需要了解消息的基本结构。如果您还不熟悉它，请阅读 link:/mule-user-guide/v/3.9/mule-message-structure[骡子消息结构]。
...
*  *NEXT STEP*：了解 link:/mule-user-guide/v/3.9/mule-expression-language-basic-syntax[MEL的基本语法]，或深入 link:/mule-user-guide/v/3.9/mule-application-architecture[Mule应用程序架构]。
* 通过示例更好地学习？访问我们的 link:/mule-user-guide/v/3.9/mule-expression-language-examples[使用MEL的示例应用程序]集合。
...
* 了解如何利用MEL中的DataWeave和 link:/mule-user-guide/v/3.9/mel-dataweave-functions[MEL DataWeave函数]
