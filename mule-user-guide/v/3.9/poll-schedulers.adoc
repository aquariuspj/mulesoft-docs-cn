...
本文档假设您一般熟悉 link:/anypoint-studio/v/6/[Anypoint Studio]和 link:http://en.wikipedia.org/wiki/Polling_(computer_science)[轮询]。详细了解Mule中的 link:/mule-user-guide/v/3.9/poll-reference[投票范围]。
...
* Learn more about link:/mule-user-guide/v/3.9/poll-reference[Poll Scopes] in Mule.
* Reference link:/mule-user-guide/v/3.9/mule-expression-language-mel[Mule Expression Language MEL].
* Learn more about link:/mule-user-guide/v/3.9/mule-expression-language-date-and-time-functions[MEL Date and Time Functions].
