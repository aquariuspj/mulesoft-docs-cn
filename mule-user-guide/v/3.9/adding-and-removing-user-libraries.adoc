...
* 有关使用Spring的更多信息，请参阅 link:/mule-user-guide/v/3.9/using-spring-beans-as-flow-components[使用Spring Beans作为流程组件]和 link:/mule-user-guide/v/3.9/about-the-xml-configuration-file[关于XML配置文件]。
