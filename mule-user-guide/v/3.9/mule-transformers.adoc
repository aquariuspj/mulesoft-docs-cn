...
*  *NEXT STEP*：请阅读大约 link:/mule-user-guide/v/3.9/mule-filters-scopes-and-routers[过滤器，范围和路由器]。
* 向前浏览以了解 link:/mule-user-guide/v/3.9/mule-message-structure[骡信息]的结构。
* 详细了解 link:/mule-user-guide/v/3.9/dataweave[DataWeave]。
* 详细了解设置，然后使用 link:/mule-user-guide/v/3.9/mule-message-structure[属性和变量]。
