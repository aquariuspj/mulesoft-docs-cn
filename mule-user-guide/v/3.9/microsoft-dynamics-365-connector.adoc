...
本文档假定您熟悉Mule， link:/mule-user-guide/v/3.9/anypoint-connectors[Anypoint连接器]和Anypoint Studio Essentials。为了提高您对Studio的熟悉度，请考虑完成一个或多个Anypoint Studio教程。此外，本页假设您对 link:/mule-user-guide/v/3.9/mule-concepts[骡流]和 link:/mule-user-guide/v/3.9/global-elements[骡全球元素]有基本的了解。
...
+
. 如果需要，请按 link:/mule-user-guide/v/3.9/using-a-connector-to-access-an-oauth-api[使用连接器访问OAuth API]中所述在全局元素属性中设置OAuth选项卡。
...
有关设置“池化配置文件”选项卡的信息，请参阅 link:/mule-user-guide/v/3.9/tuning-performance#about-pooling-profiles[关于汇集配置文件]。

有关设置重新连接选项卡的信息，请参阅 link:/mule-user-guide/v/3.9/configuring-reconnection-strategies[配置重新连接策略]。
...
*  link:/mule-user-guide/v/3.9/microsoft-dynamics-365-operations-connector[Microsoft Dynamics 365操作连接器]
