...
在将Mule应用程序部署到 link:http://www-01.ibm.com/software/webservers/appserv/was/[IBM WebSphere应用程序服务器]之前，您必须将其作为Web应用程序进行准备。这包括为您的Mule应用程序创建一个`web.xml`文件，然后创建所有支持文件的`.war`文件。
