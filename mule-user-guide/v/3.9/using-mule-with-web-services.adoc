...
*  link:/mule-user-guide/v/3.9/proxying-web-services[为现有的Web服务创建一个代理]（例如，向现有Web服务添加安全性）

在这里，我们更深入地探讨这些场景中存在哪些选项，并指导您参考其他文档资源和示例。

==  CXF模块概述

在解释使用Mule ESB可以完成的不同Web服务场景之前，重要的是要了解它所依赖的主要技术是Apache CXF。 Apache CXF是一个开源服务框架，可帮助您使用前端编程API（如JAX-WS和JAX-RS）构建和开发服务。 Mule ESB现在捆绑提供Web服务集成的 link:/mule-user-guide/v/3.9/cxf-module-reference[CXF模块]，以消耗现有的Web服务并构建新的Web服务。

[TIP]
从最新版本的Mule ESB开始，推荐使用 link:/mule-user-guide/v/3.9/cxf-module-configuration-reference[CXF模块]来处理Web服务。
...
有关更多信息，可以查看 link:/mule-user-guide/v/3.9/consuming-web-services-with-cxf[使用CXF消费Web服务]文档。
...
有关更多信息，请阅读 link:/mule-user-guide/v/3.9/consuming-web-services-with-cxf[使用CXF消费Web服务]文档。
...
*  link:/mule-user-guide/v/3.9/consuming-web-services-with-cxf[使用JAX-WS客户端API]。
*  link:/mule-user-guide/v/3.9/consuming-web-services-with-cxf[构建客户端代理]。
...
有关更多信息，请阅读 link:/mule-user-guide/v/3.9/building-web-services-with-cxf[创建一个JAX-WS服务]文档。
...
有关更多信息，请阅读 link:/mule-user-guide/v/3.9/building-web-services-with-cxf[创建一个WSDL第一个JAX-WS服务]文档。
...
有关更多信息，请阅读 link:/mule-user-guide/v/3.9/building-web-services-with-cxf[创建一个简单的前端Web服务]文档。
...
*  link:/mule-user-guide/v/3.9/proxying-web-services-with-cxf[服务器端代理]
*  link:/mule-user-guide/v/3.9/proxying-web-services-with-cxf[客户端代理]
