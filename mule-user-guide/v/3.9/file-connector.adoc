...
*Reference*： link:/mule-user-guide/v/3.9/file-transport-reference[文件传输参考]
...
有关使用XML编辑器设置File端点属性的详细信息，请参阅 link:/mule-user-guide/v/3.9/file-transport-reference[文件传输参考]。

查看 link:https://docs.mulesoft.com/mule-user-guide/v/3.9/dataweave-flat-file-schemas[DataWeave平面文件模式]文档以获取有关如何定义文件格式的信息。
