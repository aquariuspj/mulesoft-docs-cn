...
从Mule 3.1开始，您可以使用Spring Security 3.0作为Mule内部的安全管理器。您可以使用任何库的安全提供程序，例如JAAS，LDAP，CAS（耶鲁中央身份验证服务）和DAO。有关可以为Mule安全管理器配置的元素的更多信息，请参阅 link:/mule-user-guide/v/3.3/security-manager-configuration-reference[安全管理器配置参考]。
