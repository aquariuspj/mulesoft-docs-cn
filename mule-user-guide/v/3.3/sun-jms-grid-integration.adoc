...
以下配置演示了如何配置Mule中的 link:/mule-user-guide/v/3.3/jms-transport-reference[JMS传输参考]以使用 http://www.sun.com/software/products/message_service_grid/index.xml[Sun JMS Grid]服务器。
