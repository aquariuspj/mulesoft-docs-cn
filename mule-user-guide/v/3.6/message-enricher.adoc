...
您可以通过使用 link:/mule-user-guide/v/3.6/mule-expression-language-mel[Mule表达语言MEL]表达式填充字段来使源成为名称空间，例如使用从Mule消息接收参数的xpath表达式。
...
http://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/enricher/MessageEnricher.html[org.mule.core.enricher.MessageEnricher]的*  API文档
