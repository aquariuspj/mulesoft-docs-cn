...
有关更多信息，请参阅 link:/mule-user-guide/v/3.6/configuring-security[配置安全性]。
...
如果您使用CXF，则可以配置客户端和服务以使用WS-Security。有关详情，请参阅 link:/mule-user-guide/v/3.6/enabling-ws-security[启用WS-Security]。
