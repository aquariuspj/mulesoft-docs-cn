...
本文档假定您熟悉Mule中的 link:/mule-user-guide/v/3.6/anypoint-connectors[Anypoint连接器]。此外，它假定您已按照您的Studio实例上的 link:/mule-user-guide/v/3.6/installing-connectors[安装一个或多个版本的Anypoint连接器]的说明进行操作，现在希望使用Studio应用程序中的连接器。
...
* 详细了解Mule中的 link:/mule-user-guide/v/3.6/anypoint-connectors[Anypoint连接器]。
