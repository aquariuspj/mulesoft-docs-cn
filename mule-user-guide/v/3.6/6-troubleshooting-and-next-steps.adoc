...
* 有关管理Mule群集的更多信息，请参阅 link:/mule-management-console/v/3.6/managing-mule-high-availability-ha-clusters[管理HA群集]文档。
* 有关使用REST API管理Mule群集的更多信息，请参阅 link:/mule-management-console/v/3.6/rest-api-reference[REST API参考]文档。
* 有关创建或解散群集的更多信息，请参阅 link:/mule-management-console/v/3.6/creating-or-disbanding-a-cluster[创建或解散群集]文档。
