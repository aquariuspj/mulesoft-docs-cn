...
] http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_pop3/namespace-overview.html[SchemaDoc]  | image:check.png[查]  | image:error.png[错误]  | image:check.png[查]  | {{11} } image:error.png[错误]  | image:error.png[错误]  |单向 |单向 | org.mule.transport：骡传输-POP3
...
POP3连接器支持所有 link:/mule-user-guide/v/3.6/configuring-a-transport[常见的连接器属性和属性]和以下附加属性：
...
POP3和POP3S端点包含有关连接到POP3邮箱的详细信息。您 link:/mule-user-guide/v/3.6/endpoint-configuration-reference[配置端点]与其他运输方式一样，具有以下附加属性：
...
http://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transport/email/package-summary.html[Javadoc为POP3运输]
