...
有关组件配置的更多信息，请参阅 link:/mule-user-guide/v/3.6/configuring-components[配置组件]。有关用于配置组件的元素的更多信息，请参阅 link:/mule-user-guide/v/3.6/component-configuration-reference[组件配置参考]。
