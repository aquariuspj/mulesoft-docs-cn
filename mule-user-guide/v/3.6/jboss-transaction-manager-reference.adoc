...
该模块使Mule能够使用JBoss事务管理器（以前的Arjuna）来配置 link:/mule-user-guide/v/3.6/xa-transactions[XA交易]。开发人员可以配置每个Mule实例的一个Transaction Manger。有关更多信息，请参阅 http://www.jboss.org/jbosstm/[JBoss事务]。
