...
http://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transport/servlet/jetty/JettyHttpConnector.html[码头运输Javadoc]
...
Jetty端点的配置方式与 link:/mule-user-guide/v/3.6/http-transport-reference[HTTP端点]相同。请注意，Jetty传输只能用于入站端点。
