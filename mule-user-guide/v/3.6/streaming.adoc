...
*  link:/mule-user-guide/v/3.6/http-listener-connector[HTTP侦听器]和HTTPS侦听器
...
*  link:/mule-user-guide/v/3.6/domtoxml-transformer[DomToOutputHandler转换器]（如果传入的XML格式是SAXSource或XMLStreamReader）
*  link:/mule-user-guide/v/3.6/sxc-module-reference[SXC过滤器]
