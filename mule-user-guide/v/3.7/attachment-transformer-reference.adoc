...
附件变换器在功能上与 link:/mule-user-guide/v/3.7/property-transformer-reference[物业变压器]非常相似。但是，只有以下传输才能支持附件：
...
* 阅读关于相关变换器的 link:/mule-user-guide/v/3.7/property-transformer-reference[物业变压器]， link:/mule-user-guide/v/3.7/variable-transformer-reference[可变变压器]和 link:/mule-user-guide/v/3.7/session-variable-transformer-reference[会话变量变换器]，您可以使用它们为不同范围设置属性和变量。
