...
如果您熟悉v3.0之前版本的Mule，则可能需要查阅 link:/mule-user-guide/v/3.7/notes-on-mule-3.0-schema-changes[架构更改]的列表。
...
*  link:http://www.mulesoft.org/docs/site/3.7.0/apidocs/[API文档]
*  link:http://www.mulesoft.org/docs/site/3.7.0/testapidocs/[测试API文档]
