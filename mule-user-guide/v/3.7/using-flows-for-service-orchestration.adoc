...
*  link:/mule-user-guide/v/3.7/using-transformers[变形金刚]
* 过滤器
*  link:/mule-user-guide/v/3.7/routers[路由]
...
私有流是指无法通过 link:/mule-user-guide/v/3.7/endpoint-configuration-reference[骡子端点]从JVM外部访问的流，因为它没有定义消息源。
