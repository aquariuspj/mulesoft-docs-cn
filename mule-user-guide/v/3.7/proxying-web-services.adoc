...
这种类型的网桥可以与过滤器相结合，以实现简单的消息路由。对于消息的快速XPath路由，您可以使用 link:/mule-user-guide/v/3.7/sxc-module-reference[SXC模块参考]。
...
有关更多详细信息，请参阅 link:/mule-user-guide/v/3.7/proxying-web-services-with-cxf[使用CXF代理Web服务]。
