...
您可以成功 link:/mule-user-guide/v/3.7/embedding-mule-in-a-java-application-or-webapp[将Mule嵌入到Web应用程序服务器中]像Tomcat或JBoss，或者您可以在Mule流中嵌入任何其他类型的Web容器。利用Mule为其设计的集成和服务编排任务以及使用应用程序服务器来处理最终用户交互可以提供全面的功能。
