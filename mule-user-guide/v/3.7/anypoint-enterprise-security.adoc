...
在您的Anypoint Studio Enterprise Edition 3.3.2或更高版本的实例上安装 link:/mule-user-guide/v/3.7/installing-anypoint-enterprise-security[Anypoint企业安全更新]。
...
Anypoint Enterprise Security在Mule ESB Enterprise现有的安全功能之上增加了新功能。 Mule ESB已经提供了以下安全功能：
...
link:/mule-user-guide/v/3.7/mule-credentials-vault[加密属性文件]
...
link:/mule-user-guide/v/3.7/mule-message-encryption-processor[加密消息负载] +
link:/mule-user-guide/v/3.7/mule-message-encryption-processor[解密消息负载]
...
link:/mule-user-guide/v/3.7/mule-crc32-processor[对消息应用CRC] +
 +

== 另请参阅

. 在Anypoint Studio或Standalone Enterprise 3.3.2或更高版本的实例上安装 link:/mule-user-guide/v/3.7/installing-anypoint-enterprise-security[Anypoint企业安全更新]。
