...
本页介绍如何在Mule中使用独立的CXF生成的客户端。这种方法与 link:/mule-user-guide/v/3.7/consuming-web-services-with-cxf[出站路由器]方法不同，后者通常更适合于大多数应用程序。
...
*  link:https://cwiki.apache.org/confluence/pages/viewpage.action?pageId=2853210[CXF Maven插件]
