...
1.确保您已安装cf CLI。
1.下载空间配置工具 link:https://anypoint-anywhere.s3.amazonaws.com/1.5.1-GA/PCF%20Installers/space_configuration_tool_1.5.1.zip?Signature=KuhacRjLYmHt9PMa39I%2FLmZ74Hs%3D&Expires=1520192881&AWSAccessKeyId=AKIAITTY5MSTT3INJ7XQ[这里]。
...
|用于访问Anypoint平台的masterorg `cliientId`的COM_MULESOFT_ARMSERVICES_CLIENT_CLIENTID  |  。
