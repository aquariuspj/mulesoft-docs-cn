...
本文假设您熟悉 link:/anypoint-studio/v/5/index[Anypoint Connector Essentials]并准备在您的连接器上实施身份验证。它假定您熟悉各种 link:/anypoint-connector-devkit/v/3.9/authentication-methods[认证方法]，并可能使用OAuth V1对您的API进行身份验证。

如果您不熟悉OAuth V1身份验证，它是什么或如何工作，我们建议访问链接：
http://tools.ietf.org/html/rfc5849[OAuth 1.0协议/ RFC-5849]。另请参阅 link:/anypoint-connector-devkit/v/3.9/oauth-v1[OAuth V1]。
