...
* 下一步：继续 link:/anypoint-connector-devkit/v/3.9/adding-datasense[添加DataSense]到您的连接器。
* 了解如何 link:/anypoint-connector-devkit/v/3.9/developing-devkit-connector-tests[测试你的连接器]。
