...
在DevKit中，使用 link:/anypoint-connector-devkit/v/3.9/connection-management[连接管理]框架启用基本身份验证。
...
有关详情，请参阅 link:/anypoint-connector-devkit/v/3.9/oauth-v1[OAuth V1]或 link:/anypoint-connector-devkit/v/3.9/oauth-v2[OAuth V2]。

==  HTTP基本认证

在HTTP事务的上下文中，基本访问身份验证是HTTP用户代理在提出请求时提供用户名和密码的方法。

有关更多信息，请参阅 link:/anypoint-connector-devkit/v/3.9/http-basic-authentication[HTTP基本认证]。
...
|===
|方法 |更多信息
|基本身份验证 | link:/anypoint-connector-devkit/v/3.9/connection-management[连接管理]
...
| HTTP基本身份验证 | link:/anypoint-connector-devkit/v/3.9/http-basic-authentication[HTTP基本认证]
| SAML  | link:/anypoint-connector-devkit/v/3.9/connection-management[连接管理]
|的Kerberos  | link:/anypoint-connector-devkit/v/3.9/connection-management[连接管理]
| NTLM  | link:/anypoint-connector-devkit/v/3.9/connection-management[连接管理]
| LDAP  | link:/anypoint-connector-devkit/v/3.9/connection-management[连接管理]
|===
