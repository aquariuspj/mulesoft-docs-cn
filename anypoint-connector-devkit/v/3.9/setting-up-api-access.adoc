...
** 使用者密钥
{0}}消费者的秘密
. 有关在Twitter平台上创建应用程序的详细说明，请参阅 link:/getting-started/anypoint-connector#obtaining-access-to-the-twitter-api[配置Twitter的API访问]。
...
*NEXT:*继续 link:/anypoint-connector-devkit/v/3.9/creating-an-anypoint-connector-project[创建Anypoint连接器项目]开始开发连接器。
