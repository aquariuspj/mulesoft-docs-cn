...
* 按 link:/anypoint-connector-devkit/v/3.9/creating-an-anypoint-connector-project[创建Anypoint连接器项目]所述安装了Anypoint Connector DevKit插件
...
完成测试套件后，您可以为连接器 link:/anypoint-connector-devkit/v/3.9/connector-reference-documentation[生成完整的文档和样本]。
