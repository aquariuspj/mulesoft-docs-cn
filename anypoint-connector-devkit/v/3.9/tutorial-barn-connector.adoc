...
*  **NEXT STEP:**在您的连接器中实现 link:/anypoint-connector-devkit/v/3.9/authentication[认证]
*  link:/anypoint-connector-devkit/v/3.9/installing-and-testing-your-connector-in-studio[构建和安装连接器]
