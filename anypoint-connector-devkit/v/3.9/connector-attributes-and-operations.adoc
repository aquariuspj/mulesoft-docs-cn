...
更多详细信息可以在 link:/anypoint-connector-devkit/v/3.9/defining-connector-attributes[定义连接器属性]中找到。
...
有关更多详细信息，请参阅本文档中关于 link:/anypoint-connector-devkit/v/3.9/adding-datasense[添加DataSense]的静态数据模型和动态数据模型示例。
...
*  *NEXT:*继续 link:/anypoint-connector-devkit/v/3.9/defining-connector-attributes[定义连接器属性]。
