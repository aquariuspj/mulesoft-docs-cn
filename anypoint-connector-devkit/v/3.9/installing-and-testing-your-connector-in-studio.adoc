...
本文假设您有 link:/anypoint-connector-devkit/v/3.9/creating-an-anypoint-connector-project[创建一个连接器项目]。
...
有关如何打包连接器的更多信息，请查看 link:/anypoint-connector-devkit/v/3.9/packaging-your-connector-for-release[打包发布的连接器]。
...
*  *NEXT STEP:*在您的连接器上实现 link:/anypoint-connector-devkit/v/3.9/authentication[认证]。
