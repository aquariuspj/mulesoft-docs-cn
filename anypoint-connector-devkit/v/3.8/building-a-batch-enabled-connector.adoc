...
本文假定您熟悉 link:/mule-user-guide/v/3.7/batch-processing[批量处理]，您拥有 link:/anypoint-connector-devkit/v/3.8/creating-an-anypoint-connector-project[创建一个连接器项目]并且有 link:/anypoint-connector-devkit/v/3.8/connector-attributes-and-operations[定义了操作]可供使用。
...
*  *NEXT*：了解如何将 link:/anypoint-connector-devkit/v/3.8/developing-devkit-connector-tests[测试]添加到连接器。
