...
* 下一步：继续 link:/anypoint-connector-devkit/v/3.8/adding-datasense[添加DataSense]到您的连接器。
* 了解如何 link:/anypoint-connector-devkit/v/3.8/developing-devkit-connector-tests[测试你的连接器]。
