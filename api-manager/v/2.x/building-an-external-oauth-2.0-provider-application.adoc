...
*  link:/api-manager/v/2.x/to-test-local-provider[测试提供者]
*  link:/api-manager/v/2.x/external-oauth-2.0-token-validation-policy[使用外部提供者策略访问令牌执行]
*  link:/api-manager/v/2.x/aes-oauth-faq#about-oauth-provider-models[关于外部OAuth 2.0提供商]
