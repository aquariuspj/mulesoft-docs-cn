...
*  link:/api-manager/v/2.x/aes-oauth-faq#about-oauth-provider-models[外部OAuth 2.0提供商]
*  link:/api-manager/v/2.x/building-an-external-oauth-2.0-provider-application[构建一个外部OAuth 2.0提供程序]。
