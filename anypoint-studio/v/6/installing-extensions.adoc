...
link:/anypoint-studio/v/6/studio-update-sites[更新Studio，Mule和组件]。
...
*  link:/anypoint-studio/v/6/adding-community-runtime[Mule社区运行时间]
...
*  link:/anypoint-studio/v/6/using-subversion-with-studio[在Studio中使用Subversion]
