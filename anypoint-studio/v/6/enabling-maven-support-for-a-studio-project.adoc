...
* 了解如何迁移 link:/anypoint-studio/v/6/importing-a-maven-project-into-studio[一个Maven项目进入Studio]。

* 直接在Studio中了解如何 link:/anypoint-studio/v/6/building-a-mule-application-with-maven-in-studio[构建新的Maven项目]。
