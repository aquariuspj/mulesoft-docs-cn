...
在继续之前，请确保您有 link:/anypoint-studio/v/6.5/download-and-launch-anypoint-studio[下载并安装Anypoint Studio]。如果您之前没有 link:https://eclipse.org/[蚀]或基于Eclipse的IDE的经验，请查看 link:/anypoint-studio/v/6.5/[Anypoint Studio界面]的简要介绍。
...
有关如何使用可视化编辑器的更多信息，请参阅 link:/anypoint-studio/v/6.5/[快速浏览]。
